        ...
        <div className="mt-14 border-y border-white/[0.1] py-7">
          ...
          <div className="mt-7 flex max-w-3xl items-start gap-4 border-t border-white/[0.1] pt-7">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-ink-muted">
                Windows 10 and 11 setup runs from a guided window after extracting the download. It uses a one-time enrollment code and needs the <a href="https://www.python.org/downloads/windows/" target="_blank" rel="noreferrer" className="font-semibold text-signal hover:text-signal/80">latest stable Python 3 release</a> (3.11-3.14 supported), <a href="https://npcap.com/dist/" target="_blank" rel="noreferrer" className="font-semibold text-signal hover:text-signal/80">Npcap</a>, and the standard Windows administrator prompt. Windows security should remain enabled.
              </p>
            </div>
          </div>
        </div>
